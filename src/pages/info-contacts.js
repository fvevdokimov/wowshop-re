...
const OrderComplete = ({data}) => {
    ...
    return <LayoutInfo>
        <h1>Контакты</h1>
        <p>Мы всегда рады помочь вам выбрать товар и ответить на все интересующие вас вопросы о товаре и условиях оплаты, доставки, возврата товара.</p>
        <p><svg width="21" height="25" viewBox="0 0 21 25" fill="none" xmlns="http://www.w3.org/2000/svg" style={{marginRight: 6}}>
        ...
        </svg>г. Новосибирск, ул. Немировича Данченко 344, корп. 299/21, оф. 3011</p>
        <div className="fullscreen-info__bottom-nav-container">
            ...
            <Contacts/>
            <div className="fullscreen-info__bottom-nav fullscreen-info__bottom-nav-contacts">
